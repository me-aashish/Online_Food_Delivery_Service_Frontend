        ...
        <div className="flex justify-between bg-pink-50 shadow-xl">
            ...
            <div className="nav-items">
                <ul className="flex py-9">
                    <li className = "px-2 hover:bg-pink-200 rounded-lg"><Link to="/">Home</Link></li>
                    <li className = "px-2 hover:bg-pink-200 rounded-lg"><Link to="/about">About</Link></li>
                    ...
                    <li className = "px-2 hover:bg-pink-200 rounded-lg">Cart - {cartItems.length} items</li>
                </ul>
            </div>
